...
//#define PRODUCT_STRING USB_PRODUCT_STRING
   ...
   #define PRODUCT_STRING "Aquaris E10 3G"
#else
   #define PRODUCT_STRING "Aquaris E10"
#endif
...
static struct usb_string strings_dev[] = {
	...
	[STRING_SERIAL_IDX].s = USB_STRING_SERIAL_IDX, /*ckt modify*/
	{  }			/* end of list */
};
...
#else
#ifdef CKT_WITHOUT_EXTERNAL_SDCARD //ckt liutao 20140313 for no external sdcard
#define NLUN_STORAGE 1
#else
