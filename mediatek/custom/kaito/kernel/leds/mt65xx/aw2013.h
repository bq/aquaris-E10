...
//#define AW2013_SDA_PIN				214//66                //I2C data ÅäÖÃ
//#define AW2013_SCK_PIN				215//67                //I2C clock ÅäÖÃ

#define GPIO_LED_EN 11 //liubiao
#define GPIO_LED_EN_M_GPIO 12
#define aw2013_RESET_PIN GPIO_LED_EN                //aw2013µÄRESETœÅ


#define AW2013_I2C_ADDRESS_WRITE			0x8A             //I2C ÐŽµØÖ·
#define AW2013_I2C_ADDRESS_READ			0x8B             //I2C ¶ÁµØÖ·

#define AW2013_I2C_MAX_LOOP 		50   

#define I2C_delay 		2    //¿ÉžùŸÝÆœÌšµ÷Õû,±£Ö€I2CËÙ¶È²»žßÓÚ400k

#define AW2013_I2C_BUS_NUM 0

//ÒÔÏÂÎªµ÷œÚºôÎüÐ§¹ûµÄ²ÎÊý
#define Imax          0x01//0x02   //LED×îŽóµçÁ÷ÅäÖÃ,0x00=omA,0x01=5mA,0x02=10mA,0x03=15mA,
#define Rise_time   0x00   //LEDºôÎüÉÏÉýÊ±Œä,0x00=0.13s,0x01=0.26s,0x02=0.52s,0x03=1.04s,0x04=2.08s,0x05=4.16s,0x06=8.32s,0x07=16.64s
#define Hold_time   0x01   //LEDºôÎüµœ×îÁÁÊ±µÄ±£³ÖÊ±Œä0x00=0.13s,0x01=0.26s,0x02=0.52s,0x03=1.04s,0x04=2.08s,0x05=4.16s
#define Fall_time     0x00   //LEDºôÎüÏÂœµÊ±Œä,0x00=0.13s,0x01=0.26s,0x02=0.52s,0x03=1.04s,0x04=2.08s,0x05=4.16s,0x06=8.32s,0x07=16.64s
#define Off_time      0x01   //LEDºôÎüµœÃðÊ±µÄ±£³ÖÊ±Œä0x00=0.13s,0x01=0.26s,0x02=0.52s,0x03=1.04s,0x04=2.08s,0x05=4.16s,0x06=8.32s,0x07=16.64s
#define Delay_time   0x00   //LEDºôÎüÆô¶¯ºóµÄÑÓ³ÙÊ±Œä0x00=0s,0x01=0.13s,0x02=0.26s,0x03=0.52s,0x04=1.04s,0x05=2.08s,0x06=4.16s,0x07=8.32s,0x08=16.64s
#define Period_Num  0x00   //LEDºôÎüŽÎÊý0x00=ÎÞÏÞŽÎ,0x01=1ŽÎ,0x02=2ŽÎ.....0x0f=15ŽÎ
