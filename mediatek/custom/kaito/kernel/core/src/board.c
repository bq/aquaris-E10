...
void mt_power_off(void)
{
	...
	while (KAL_TRUE == pmic_chrdet_status()) {
		printk("with charger\n");
...
/*=======================================================================*/
#define MSDC_SDCARD_FLAG  (MSDC_SYS_SUSPEND | MSDC_WP_PIN_EN | MSDC_CD_PIN_EN | MSDC_REMOVABLE | MSDC_HIGHSPEED | MSDC_UHS1 | MSDC_DDR)
