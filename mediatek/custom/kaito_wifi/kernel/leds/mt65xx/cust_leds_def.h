...
enum mt65xx_led_mode
{
	...
	MT65XX_LED_MODE_CUST,//wangli_20140930
...
extern int mt_backlight_set_pwm(int pwm_num, unsigned int level, unsigned int div, struct PWM_config *config_data);//wangli_20140814:for pwm mode
