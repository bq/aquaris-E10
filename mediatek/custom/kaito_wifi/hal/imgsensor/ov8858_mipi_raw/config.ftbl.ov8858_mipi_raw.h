...
//                MtkCameraParameters::SCENE_MODE_NORMAL, 
 ...
 #if 1//defined (CKT_INTERPOLATION) 
 	      ITEM_AS_DEFAULT_("4224x3168"),
 #else
            ITEM_AS_DEFAULT_("3264x2448"), 
#endif
            ITEM_AS_VALUES_(
                "320x240",      "640x480",      "1024x768",     "1024x688",	"1280x720",     "1280x768",     "1280x960", 
                "1600x1200",    "2048x1360",	"2048x1536",    "2560x1440",    "2560x1712",	"2560x1920",    "3264x2448",    
		"3328x1872", 	"2880x1728",    "3600x2160",	"3600x2400",	"3800x2280",  "3900x2600",
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("960x720"), 
            ITEM_AS_VALUES_(
                "176x144",      "320x240",      "352x288",      "480x320",      "480x368", 
                "640x480",      "720x480",      "800x600",      "864x480", 
                "960x540",      "960x720",      "1024x688",	"1280x720", 	"1600x960",
            )
        ), 
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "176x144",    "720x480",  "1280x720",     "1920x1080", 
            )
        ), 
    )
#endif
