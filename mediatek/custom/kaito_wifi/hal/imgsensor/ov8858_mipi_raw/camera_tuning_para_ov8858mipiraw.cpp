...
{{
    ...
    ISPCcmPoly22:{
        ...
        20578,    // i4B_STD
        {  // i4P00[9]
            4775000, -2312500, 82500, -832500, 3695000, -297500, -102500, -2332500, 4995000
        },
        {  // i4P10[9]
            1213496, -1309716, 101547, 82957, -129210, 72547, 57524, -146588, 94879
        },
        {  // i4P01[9]
            878900, -923883, 41213, -72067, -216320, 304799, -101246, -968198, 1079871
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        ...
        // rHistConfig
        {
            ...
            {18, 22, 35, 30, 34}    // u4BlackLightThres[AE_CCT_STRENGTH_NUM] 
        },
        // rCCTConfig
        {
