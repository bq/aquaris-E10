...
PRJ_MF := $(MTK_ROOT_CONFIG_OUT)/ProjectConfig.mk $(MTK_ROOT_CONFIG_OUT)/ProjectConfig_ckt.mk
...
newall: cleanall remakeall ckt_release
cleanall: preclean
...
backup_symbols:
	ckt/backup_symbols.sh

ckt_release:
	$(hide) CKT_BUILD_VERNO="$(CKT_BUILD_VERNO)" \
	CUSTOM_MODEM=ckt92_tb_kk_hspa \
    ckt/ckt_release.sh

$(MTK_ROOT_CONFIG_OUT)/ProjectConfig_ckt.mk:mediatek/config/$(PROJECT)/ProjectConfig_ckt.mk
	$(hide) cp mediatek/config/$(PROJECT)/ProjectConfig_ckt.mk $(MTK_ROOT_CONFIG_OUT)/ProjectConfig_ckt.mk

#得到modem的hash   苏 勇 2013年08月27日16:26:56 
modemhash:
	$(hide) grep -awoe 'HASH_[0-9,a-z]\{7\}' mediatek/custom/common/modem/ckt92_tb_kk_hspa/*.img
