...
static void pchr_turn_on_charging (void)
{
    ...
    else
    {
		...
		else
		{
                            ...
                            else if((BMT_status.temperature >= CURRENT_LIMIT_TEMPERATURE_40_DEGREE) && (BMT_status.temperature < CURRENT_LIMIT_TEMPERATURE_42_DEGREE))
                            {//40~42 degree
                                g_temp_input_CC_value = CHARGE_CURRENT_1700_00_MA;
                                g_temp_CC_value = CHARGE_CURRENT_1700_00_MA;
                            }
                             else if((BMT_status.temperature >= CURRENT_LIMIT_TEMPERATURE_42_DEGREE) && (BMT_status.temperature < CURRENT_LIMIT_TEMPERATURE_44_DEGREE))
                            {//42~44 degree
                                g_temp_input_CC_value = CHARGE_CURRENT_1400_00_MA;
                                g_temp_CC_value = CHARGE_CURRENT_1400_00_MA;
                            }
                             else if((BMT_status.temperature >= CURRENT_LIMIT_TEMPERATURE_44_DEGREE) && (BMT_status.temperature < CURRENT_LIMIT_TEMPERATURE_46_DEGREE))
                            {//44~46 degree
                                g_temp_input_CC_value = CHARGE_CURRENT_1100_00_MA;
                                g_temp_CC_value = CHARGE_CURRENT_1100_00_MA;
                            }
                             else if((BMT_status.temperature >= CURRENT_LIMIT_TEMPERATURE_46_DEGREE) && (BMT_status.temperature < CURRENT_LIMIT_TEMPERATURE_48_DEGREE))
                            {//46~48 degree
                                g_temp_input_CC_value = CHARGE_CURRENT_800_00_MA;
                                g_temp_CC_value = CHARGE_CURRENT_800_00_MA;
                            }
                             else if((BMT_status.temperature >= CURRENT_LIMIT_TEMPERATURE_48_DEGREE) && (BMT_status.temperature < MAX_CHARGE_TEMPERATURE))
                            {//48~50 degree
                                g_temp_input_CC_value = CHARGE_CURRENT_500_00_MA;
                                g_temp_CC_value = CHARGE_CURRENT_500_00_MA;
                            }
