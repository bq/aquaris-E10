...
MTK_PRODUCT_LOCALES=en_GB en_US es_ES zh_CN zh_TW ru_RU pt_BR fr_FR de_DE tr_TR it_IT in_ID ms_MY vi_VN ar_EG  th_TH  pt_PT   nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ iw_IL my_MM km_KH ko_KR pl_PL es_US bg_BG hr_HR lv_LV lt_LT sk_SK uk_UA de_AT da_DK fi_FI nb_NO sv_SE ca_ES
...
BQ_PRODUCT_MODEL = Aquaris E10 3G
BQ_PRODUCT_BRAND = bq
BQ_PRODUCT_NAME = Aquaris_E10_3G
BQ_TARGET_DEVICE = Aquaris_E10_3G
TARGET_BOARD_PLATFORM = MT8392
PRODUCT_MANUFACTURER = bq
# ckt zhangyan 20140326 add end

#Distinguish between 3G and wifi version
CKT_KAITO_3G_VERNO = yes

#added by WangGuoquan Sep/17/2014
MTK_TB_MODE_WIFI_ONLY = no
